...
import 'package:flutter_batu/product/view/updateTransaksiAdmin.dart';
// ignore: unused_import
...
class ListTransaksiAdmin extends StatefulWidget {
  const ListTransaksiAdmin({super.key});

  @override
  State<ListTransaksiAdmin> createState() => _ListTransaksiAdminState();
}

List _get = [];

class _ListTransaksiAdminState extends State<ListTransaksiAdmin> {
  Future riwayatTiket() async {
    try {
      ...
      var _riwayatTiket = Uri.parse(
          'https://batu.dlhcode.com/api/pemesanan');
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                  if (_get[index]['status_pemesanan'] == 'Pending' || _get[index]['status_pemesanan'] == 'Selesai') {
                    showDialog<String>(
                      context: context,
                      builder: (BuildContext context) => AlertDialog(
                        title: const Text('Status Pembayaran'),
                        content:
                            const Text('Pesanan belum melakukan pembayaran atau Pesana Sudah Selesai'),
                        actions: <Widget>[
                          TextButton(
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UpdateTransaksiAdmin(
